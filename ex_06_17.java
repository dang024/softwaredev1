...
the following header: public static void printMatrix(int n)Each element is 0 or 1, which is generated randomly.
...
public class ex_06_17{
    ...
    Scanner input = new Scanner(System.in);
        ...
        System.out.println("Enter n to display an n-by-n matrix.");
            int n = input.nextInt();
